...
namespace zCalcMoney
{
    public partial class KoefForm : MetroFramework.Forms.MetroForm
    {
        ...
        {
            Calc.Vivod(index, metroTextBox1, metroTextBox2, metroTextBox3, metroTextBox4, metroTextBox5, metroTextBox6, metroTextBox7, metroTextBox8, metroTextBox9, metroTextBox10, conn);
        }
