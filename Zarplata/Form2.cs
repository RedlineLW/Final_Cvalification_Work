...
namespace Zarplata
{
    ...
    {
        KoefForm edit_koef;
        string conn = "server = 127.0.0.1; port = 3306; user = root; database = testdb; password = '';"; //server = chuc.caseum.ru; port = 33333; user = st_2_18_23; database = is_2_18_st23_VKR; password = 51922291;
